...
class TestForumIndex(TestCase):
    ...
    def test_get_topics(self):
        ...
        self.assertIn(self.forum_topics[0], topics)

        # Check that the unpublished topic was not included
        self.assertNotIn(self.unpublished_topic, topics)

        # Check that no topics from the sub forum were included
        self.assertNotIn(self.sub_forum_topics[0], topics)
    ...
    def test_get_all_topics(self):
        ...
        self.assertIn(self.sub_forum_topics[0], topics)
