...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('wagtailforums_forumreply', (
        ...
        db.send_create_signal('wagtailforums', ['ForumReply'])

        # Adding model 'ForumTopic'
        db.create_table('wagtailforums_forumtopic', (
            ('page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wagtailcore.Page'], unique=True, primary_key=True)),
            ('message', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('wagtailforums', ['ForumTopic'])

        # Adding model 'ForumIndex'
        db.create_table('wagtailforums_forumindex', (
            ('page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wagtailcore.Page'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('wagtailforums', ['ForumIndex'])


    def backwards(self, orm):
        # Deleting model 'ForumReply'
        db.delete_table('wagtailforums_forumreply')

        # Deleting model 'ForumTopic'
        db.delete_table('wagtailforums_forumtopic')

        # Deleting model 'ForumIndex'
        db.delete_table('wagtailforums_forumindex')
